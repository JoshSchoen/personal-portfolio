...
We continued with the test, once the test became statistically significant there was a clear winner, moving the email field to be co-located with the shipping form was the winner. We implemented the change and over the next few months we saw the conversation rate increase of 1.65%.
