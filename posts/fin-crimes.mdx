...
<Text marginBottom="8" marginTop="4" fontSize="lg">
  ...
  Possible". Basically it was where business ideas went to incubate to evaluate if the idea had legs to be brought on as a product or addon features for an existing product. If the idea didn't ake off, the ideas, components and resources often morphed into different initiatives or drove other ideas. Apologies for spoilers, this project was not much different, but it did reshaped my career along with other business specific outcomes.
</Text>
<Flex>
